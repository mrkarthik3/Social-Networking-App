 ...
 export default class Search {
    ...
    renderResultsHTML(posts) {
        if(posts.length) {
            // Manipulate the results area div
            ...
            this.resultsArea.innerHTML = `<p class= "alert alert-danger text-center">Sorry, we could not find any results</p>`
